...
#endif
{
	...
	fprintf(INFO, "Copyright (C) 2007-2013 The OpenTyrian Development Team\n\n");

	fprintf(INFO, "This program comes with ABSOLUTELY NO WARRANTY.\n");
	fprintf(INFO, "This is free software, and you are welcome to redistribute it\n");
	fprintf(INFO, "under certain conditions.  See the file GPL.txt for details.\n\n");
	#if defined USE_SDL2
	if (SDL_Init(0))
	{
...
#else
		fprintf(ERROR, "OpenTyrian was compiled without networking support.");
		JE_tyrianHalt(5);
#endif
	}
